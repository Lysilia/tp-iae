...
CREATE TABLE Plop (ID INTEGER NOT NULL, C_1 VARCHAR(255), C_2 VARCHAR(255), PRIMARY KEY (ID))
CREATE TABLE A (ID INTEGER NOT NULL, A_1 VARCHAR(255), A_2 VARCHAR(255), PRIMARY KEY (ID))
ALTER TABLE B ADD CONSTRAINT FK_B_C_ID FOREIGN KEY (C_ID) REFERENCES Plop (ID)
